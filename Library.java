...
public class Library implements ActionListener{
	...
	Library()
	{
		frame6 = new JFrame("LIBRARY");
		frame6.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		l1 = new JLabel("<html><span style='font-size:25px; color:Red;'>"+"Library Records"+"</span></html>");
		la=new JLabel("Admission Number:");
		la2=new JLabel("   EFEF  ");
		
		l2=new JLabel("BOOKS ISSUED");
